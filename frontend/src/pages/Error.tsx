...
const Error = () => {
  return (
    <div className="w-full flex bg-grayblack h-[calc(100vh-4rem)] justify-around items-center">
      ...
      <p className="text-6xl md:text-7xl lg:text-[12rem] font-bold tracking-wider text-white">404</p>
      ...
      <div className=" text-white flex flex-col items-center">
        ...
        <button className="sm:w-full lg:w-auto mt-16 border rounded md py-4 px-8 text-center
